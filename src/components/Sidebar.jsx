...
const Sidebar = () => {
    ...
    return (
        <aside className={`${open ? "w-72" : " w-0 lg:w-20 "} bg-white border-r shadow-sm fixed lg:relative  top-0 bottom-0 z-50 ${open ? "overflow-y-auto" : ""}`}>
            <nav className='h-full flex flex-col bg-white border-r shadow-sm'>
                                ...
                                >
                                    ...
                                    {menu.subMenu && (
                                        <BsChevronDown
                                            ...
                                            className={`${subMenuOpen[index] && "rotate-180"} ${!open && "hidden"}`}
                                            size={20}
                                        />
                                    )}
                                    {!open && (
                ...
                <div className='border-t flex p-3'>
                    <div className={`px-2 ${!open && "hidden lg:block"} `}> <MdLogout size={25} /> </div>
                    <div className={`flex justify-between items-center overflow-hidden transition-all w-52 ml-3  text-gray-600 ${!open && "hidden"}`}>
