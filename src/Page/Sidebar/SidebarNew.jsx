...
const SidebarNew = () => {
  ...
  return (
    <div className=" h-screen flex  ">
      <button
        className="fixed z-90 bottom-10 right-8 bg-teal-800 w-10 h-10 rounded-full drop-shadow-lg flex justify-center items-center text-white text-4xl hover:bg-teal-800   duration-300"
      ...
      <div
        className={` ${open ? 'w-48 px-2 lg:w-72' : 'md:w-0 '
          }  bg-teal-800 h-screen   md:hidden top-0 bottom-0 duration-500 `}
      >
      {/* <div
