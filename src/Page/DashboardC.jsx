...
import { MdEditSquare, MdEdit, MdDelete } from "react-icons/md";
  ...
  return (
    <div className='p-3 '>
        <div className='flex flex-row items-center justify-between h-16 rounded-md p-3 bg-gray-50 mb-10'>
            ...
            <button className='bg-blue-700 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'>Create</button>
        </div>
    ...
    <table className="w-full font-medium text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td className="px-6 py-4">
                    <span className='bg-blue-100 text-blue-800  font-medium me-2 px-2.5 py-0.5 rounded'>Silver</span>
                </td>
                <td className="px-6 py-4">
                    Silver
                </td>
            ...
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td className="px-6 py-4">
                <span className='bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded'>Silver</span>
                </td>
                <td className="px-6 py-4">
                    White
                </td>
    ...
    <table className="border-collapse border border-slate-400 w-full font-medium text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td className="px-6 py-4 border border-slate-300">
                    <span className='bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded'>Silver</span>
                </td>
                <td className="px-6 py-4 border border-slate-300">
                    Silver
                </td>
